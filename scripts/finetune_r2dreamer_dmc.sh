...
# Stage-2 backdoor fine-tune for R2-Dreamer on DMC (vision).
# Expects a clean stage-1 run under logdir/<DATE>_r2dreamer_<task>_<seed>/latest.pt
# (produced by scripts/r2dreamer_dmc.sh)
