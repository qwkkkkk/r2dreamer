...
用法：
    python scripts/viz/extract_videos.py --logdir ./logdir/0416_dreamer_walker_walk_s0
    python scripts/viz/extract_videos.py --logdir ./logdir
    python scripts/viz/extract_videos.py --logdir ./logdir --n 10
"""
