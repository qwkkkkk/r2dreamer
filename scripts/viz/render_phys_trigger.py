...
Usage:
    ...
    MUJOCO_GL=egl MUJOCO_EGL_DEVICE_ID=0 python scripts/viz/render_phys_trigger.py
    python scripts/viz/render_phys_trigger.py --tasks reach door-open --frames 4
"""
