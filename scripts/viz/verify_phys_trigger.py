...
Usage (from repo root):
    python scripts/viz/verify_phys_trigger.py
    python scripts/viz/verify_phys_trigger.py --task reach --n 8 --out /tmp/trigger_verify
    python scripts/viz/verify_phys_trigger.py --pos 0.10 -0.40 0.02 --size 0.030
"""
